...
for o, back in enumerate(trialsback):
	...
	axs[o].scatter(xdata, bias, color='k', s=5)
	axs[o].plot(xdata, func(xdata, popt[0], popt[1]), c='k')
...
fig.savefig("figs/bias_%s_ISI%s.png"%(SimulationName,ISI), bbox_inches='tight')
fig.savefig("figs/bias_%s_ISI%s.svg"%(SimulationName,ISI), bbox_inches='tight')
