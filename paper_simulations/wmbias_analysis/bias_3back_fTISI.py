...
# First plot the bias for each delay separately
for k, ISI in enumerate(ISIvals):
...
fig.savefig("figs/bias_%s_fISI.png"%(SimulationName), bbox_inches='tight')
fig.savefig("figs/bias_%s_fISI.svg"%(SimulationName), bbox_inches='tight')
